    ...
    <table id="example" class="table table-striped" style="width:100%">
        ...
        @foreach($products as $item)
            ...
            <tr>
                ...
                <td>
                    <div class="dropdown">
                        <button class="btn btn-white dropdown-toggle border-black text-black border-2"
                                type="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <form action="{{ route('admin.products.destroy', $item->id) }}" method="POST" class="d-inline w-100">
                                    @csrf
                                    @method('DELETE')
